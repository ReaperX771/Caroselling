        ...
        <div className='w-[90%] m-auto py-20'>
           ...
           <div className='flex flex-col lg:grid gap-10 lg:grid-cols-2'>
              {leters.map((leter , index)=>(
                ...
                <div key={index} className='sm:w-140 lg:w-140 flex flex-col gap-7'>
                    <img className='w-100 sm:w-140  max-sm:w-140' src={leter.img}/>
                   <div className='text-white flex justify-between'>
                    <div className='flex gap-7  md:gap-17 text-sm lg:text-lg'>
                     <h1 className='whitespace-pre-line hover:text-[#4076FF] duration-700'>{leter.text}</h1>
                      <h1 className='whitespace-pre-line hover:text-[#4076FF] duration-700'>{leter.stext}</h1>
                    </div>
                       
                      <p className='text-5xl lg:text-7xl hover:text-[#4076FF] duration-700'>{leter.plus}</p>
                   </div>
                </div>
